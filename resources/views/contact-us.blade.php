...
<head>
    <meta charset="utf-8">
    <title>MicroTech | Contact Us</title>
    <!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <div class="alert alert-success alert-dismissable">
         ...
         <p align="center"><strong>Success!</strong> {{session('message_sent')}}</p>
    </div>
    ...
    <div class="main-content-area">
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <!--Contact us-->
                <section class="contact-us col-lg-12">
                            ...
                            <div class="info-box">
                                <ul>
                                    <li>
                                        ...
                                        <p>+880 2 9362112, +880 2 9352263</p>
                                    </li>
                                    <li>
                                        <span class="fa fa-envelope-o"></span>
                                        <strong>Email Address</strong>
                                        <p>
                                            info@microtechbd.com, microtechglobal@gmail.com
                                        </p>
                                    </li>
                                    <li>
                                        <span class="fa fa-map-marker"></span>
                                        <strong>Our Location</strong>
                                        <p class="m-0">177,Mahatab Centre, Floor # 4th, Suit # 8</p>
                                        <p>Bijoynagar, Dhaka-1000, Bangladesh</p>
                                    </li>
                                </ul>
                            </div>

                            <!--Location Map-->
                            <div style="display:none;" class="location-map" id="our-location"></div>
