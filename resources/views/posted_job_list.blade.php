...
<div class="col-md-10 col-md-offset-1">
    ...
    <div class="panel-heading"><h4><strong>Job Advertisement List</strong></h4></h4></div>
    <div class="panel-body">
        
       
      @if (count($datas)===0)
            <div class="alert alert-danger" role="alert">
              <p align="center"><strong>List Empty!!</strong> Currently there are no Job advertisement!</p>
        </div>
      
        @else
         <div class="table-responsive">

             <form class="form-horizontal" role="form" method="POST" action="{{ url('/vacancy_list_button') }}">
                {!! csrf_field() !!}
